...
const QString BITCOIN_IPC_PREFIX("Huangjincoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Huangjincoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Huangjincoin: click-to-pay handler");
    else
...
{
    // clicking on Huangjincoin: URLs creates FileOpen events on the Mac:
